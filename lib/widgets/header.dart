                ...
                child: Row(
                  children: [
                    GestureDetector(
                      ...
                      child: Image.asset(Images.pickup_point, height:25, width: 25, color: /*ColorCodes.badgecolor*/Colors.white)/*Icon(Icons.location_on,
                                ...
                                text: new TextSpan(
                                  children: <TextSpan>[
                                    ...
                                    new TextSpan(
                                      ...
                                      style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 8, color: ColorCodes.whiteColor ),
                                    ),
                                  ],
                                ),
                              ),
