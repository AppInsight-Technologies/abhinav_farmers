...
*/
  ...
  Widget build(BuildContext context) {
    ...
    debugPrint("country code and countryname"+IConstants.countryCode + countryName.toString());
    return WillPopScope(
      onWillPop: () async {
        skip();
        return false;
            ...
            child: Column(children: <Widget>[
              ...
              Container(
                ...
                child: Text(
                  ...
                  style: TextStyle(fontSize: 13, color: IConstants.isEnterprise? ColorCodes.blackColor:ColorCodes.liteColor),
                ),
              ),
              GestureDetector(
                onTap: () {
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      width: 1.0,
                      color: IConstants.isEnterprise? ColorCodes.primaryColor:ColorCodes.primaryColor,
                    ),
                  ),
                  child: Text(
                        ...
                        Container(
                          ...
                          child: Center(
                              child: Text(
                                ...
                                style:
                                TextStyle(fontSize: 13.0, color: ColorCodes.emailColor),
                              )),
                        ),
                        // Expanded(
                        //   child: Divider(
                        ...
                        child: GestureDetector(
                          ...
                          child: Material(
                            ...
                            child: Container(
                              ...
                              child:
                              Padding(
                                padding: EdgeInsets.only(right:10,//30.0,
                                  left:10,),
                                child: Row(
                                  crossAxisAlignment: CrossAxisAlignment.center,
                                  mainAxisAlignment: MainAxisAlignment.center,
