...
class _SubscribeScreenState extends State<SubscribeScreen> with Navigations {
  ...
  String _subscriptionminimumOrderAmountNoraml = "0.0";
  String _subscriptiondeliveryChargeNormal = "0";
  String _subscriptionminimumOrderAmountPrime = "0.0";
  String _subscriptiondeliveryChargePrime = "0";
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () async {
      ...
      if (addressdata.billingAddress!.length <= 0 || !Features.isdeliverychargesubscription){
        SubscriptionApi.getSubscriptionPromoplan(ParamBodyData(
          branchtype: IConstants.isEnterprise && Features.ismultivendor
              ? IConstants.branchtype.toString()
              : "",
          ...
          _futureSubscriptionPromoplan.then((value) {
            if (value.status == 200) {
              ...
              if(SubscriptionPromoplanlength > 0) {
                ...
                if (Features.isdeliverychargesubscription) {
                  if (_checkmembership) {
                    minOrdAmount = _subscriptionminimumOrderAmountNoraml;
                    delCharge = _subscriptiondeliveryChargePrime.toString();
                  }
                  else {
                    minOrdAmount = _subscriptionminimumOrderAmountNoraml;
                    delCharge = _subscriptiondeliveryChargeNormal.toString();
                  }

                  if (subscriptiondata[0].grandtotal! <
                      double.parse(minOrdAmount)) {
                    if (value.data![0].isdefault != "1")
                      deliveryAmt = double.parse(delCharge) * int.parse(
                          value.data![0].days!);
                    else
                      deliveryAmt = double.parse(delCharge);
                  } else {
                    deliveryAmt = 0;
                  }
                  ...
                  if (deliveryAmt <= 0) {
                    ...
                    IConstants.numberFormat == "1" ? "+ " +
                        deliveryAmt.toStringAsFixed(0) + " " +
                        IConstants.currencyFormat :
                    "+ " + deliveryAmt.toStringAsFixed(
                    ...
                    IConstants.numberFormat == "1" ? "+ " +
                        ...
                        deliveryAmt.toStringAsFixed(0) :
                    "+ " + IConstants.currencyFormat + " " +
                        deliveryAmt.toStringAsFixed(IConstants.decimaldigit);
                  }
                }
              }
            }
    ...
    Provider.of<BrandItemsList>(context,listen: false).deliveryCharges(addressid).then((_) {
      setState(() {
        ...
        if (delChargeData.itemsDelCharges.length <= 0) {
          ...
          _subscriptionminimumOrderAmountNoraml = delChargeData.itemsDelCharges[0].minimum_order_amount_subscription;
          _subscriptiondeliveryChargeNormal =
              delChargeData.itemsDelCharges[0].delsubscription;
          _subscriptiondeliveryChargePrime =
              delChargeData.itemsDelCharges[0].delprimesubscription;
          loading = false;
          if(_checkmembership){
            minOrdAmount = _subscriptionminimumOrderAmountNoraml;
            delCharge = _subscriptiondeliveryChargePrime.toString();
          ...
          SubscriptionApi.getSubscriptionPromoplan(ParamBodyData(branchtype: IConstants.isEnterprise && Features.ismultivendor?IConstants.branchtype.toString():"",
            ...
            id: widget.itemid,
            ref: IConstants.refIdForMultiVendor.toString(),
            price: _price.replaceAll(IConstants.currencyFormat, ""),
            total: _price.replaceAll(IConstants.currencyFormat, ""),
          )).then((value) {
            setState(() {
              _futureSubscriptionPromoplan = Future.value(value);
              // loader=false;
              _futureSubscriptionPromoplan.then((value) {
                if( value.status == 200 ){
                  ...
                  if (Features.isdeliverychargesubscription) {
                    ...
                    debugPrint("subscriptiondata[0].grandtotal!..."+subscriptiondata[0].grandtotal.toString()+"..."+ double.parse(minOrdAmount).toString());
                    if (subscriptiondata[0].grandtotal! < double.parse(minOrdAmount)) {
                      //  deliveryAmt = double.parse(delCharge) ;
                      if(value.data![0].isdefault !="1")
                        deliveryAmt =  double.parse(delCharge) * int.parse(value.data![0].days!) ;
                      else
                        deliveryAmt =  double.parse(delCharge);
                    } else {
                      // deliveryAmt = 0;
                    ...
                    debugPrint("subscriptiondata[0].grandtotal!...1.."+deliveryAmt.toString());
        ...
        onPressed: (){
          setState(() {
            ...
            if(address == ""){
              ...
              double total= /*((_itemCount * TotalAmount!) * (deliveryNum))*/(SubscriptionPromoplanlength >0)?TotalAmount!:0.0;
              List<String> weeks  = [];
              ...
              if (paymentMode.toString() == "0") {
                ...
                Navigation(context, name: Routename.PaymenSubscription, navigatore: NavigatoreTyp.Push,
                    qparms: {
                      ...
                      "varType" : widget.varType,
                      "deliverycharge" : deliveryAmt.toString(),
                      "deliverychargenormal": _subscriptiondeliveryChargeNormal.toString(),
                      "deliverychargeprime": _subscriptiondeliveryChargePrime.toString(),
                    });
              }else{
                CreateSubscription();
              }
                                      ...
                                      itemBuilder: (BuildContext context, int index) {
                                        return GestureDetector(
                                          onTap: (){
                                            ...
                                            setState(() {
                                              if(Features.isdeliverychargesubscription) {
                                                if (SubscriptionPromoplan
                                                    .data![index].grandtotal! <
                                                    double.parse(minOrdAmount)) {
                                                  if(SubscriptionPromoplan.data![index].isdefault !="1")
                                                    deliveryAmt =  double.parse(delCharge) * int.parse(SubscriptionPromoplan.data![selectedIndex!].days!) ;
                                                  else
                                                    deliveryAmt =  double.parse(delCharge);
                                                } else {
                                                  deliveryAmt = 0;
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  (deliverychargetext != "FREE")?
                                  Text(
                                    "( "+ IConstants.currencyFormat + delCharge +" " +S .current.per_day+" )",
                                    style: TextStyle(
                                        fontSize: 12,
                                        color: Colors.black),
                                  ):SizedBox.shrink(),
                              ...
                              Spacer(),
                              Text(deliverychargetext.toString(),
                                style: TextStyle(
                                    fontSize: 16,
                                    fontWeight: FontWeight.bold,
                                    color: ColorCodes.primaryColor
                                ...
                                itemBuilder: (BuildContext context, int index) {
                                  return GestureDetector(
                                    onTap: (){
                                      ...
                                      print("check membership..."+_checkmembership.toString());
                                      print("plan total...."+SubscriptionPromoplan.data![index].grandtotal.toString() + "min amt..." +minOrdAmount.toString());
                                        setState(() {
                                          if(Features.isdeliverychargesubscription) {
                                            if (SubscriptionPromoplan
                                                .data![index].grandtotal! <
...
//               )
  ...
  Future<void> CreateSubscription() async {
    ...
    if(_checkmembership) {
      resBody["subscriptionDeliveryCharge"] = /*routeArgs['deliveryChargePrime']*//*_subscriptiondeliveryChargePrime*/deliveryAmt.toString();
    }else{
      resBody["subscriptionDeliveryCharge"] = /* routeArgs['deliveryChargeNormal']*//*_subscriptiondeliveryChargeNormal*/deliveryAmt.toString();
    }
    ...
    debugPrint("order placing response....."+Api.subscriptionCreate.toString() + "/////"+resBody.toString());
    // debugPrint("body...sub..."+{
    ...
    print("response.....3"+response.body.toString());
