...
//              itemImage: IConstants.API_IMAGE + "items/images/" + data[i]['image'].toString(),
  ...
  Future<void> GetSubscriptionorders() async {
    ...
    try {
      ...
      final responseJson = json.decode(utf8.decode(response.bodyBytes));
      print("response subscription order...."+responseJson.toString());
      if (responseJson.toString() == "[]") {
      } else {
        for (int i = 0; i < responseJson.length; i++) {
          ...
          _itemssub.add(MyordersFields(
            ...
            subscription_delivery_charge:  responseJson[i]["subscription_delivery_charge"] == "null" || responseJson[i]["subscription_delivery_charge"] == ""?"":responseJson[i]["subscription_delivery_charge"].toString()
          ));
        }
      }
  ...
  Future<void> Viewsubscriptionorders(String orderId) async {
    ...
    try {
      ...
      print("response view subscription.,,,,,"+Api.viewSubscriptionList + orderId.toString());
      final responseJson = json.decode(utf8.decode(response.bodyBytes));
      ...
      if (responseJson.toString() == "[]") {
        ...
        for (int i = 0; i < responseJson.length; i++) {
          ...
          _subitemorder.add(MyordersFields(
            ...
            subscription_delivery_charge: responseJson[i]['subscription_delivery_charge'].toString()
